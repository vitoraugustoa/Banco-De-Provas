...
<head>
    ...
    <title>Banco de Provas - Minhas Provas</title>
      ...
      require_once('/default-pages/config-menu.php') ?>
        <main class="mdl-layout__content padding-layout">
            <div class="mdl-grid conf-titulo-page">
                <h5 class="mdl-cell mdl-cell--12-col">Minhas Provas</h5>
            </div>
            <hr />
            <div class="mdl-grid container-center">
                <div class="mdl-cell mdl-cell--6-col">
                    <a href="tela-adicionar-prova.php" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
                        <strong>Criar Prova</strong>
                    </a>
                </div>
                <div class="mdl-cell mdl-cell--6-col conf-abrir-filtro">
                ...
                <div class="mdl-grid margin-top">
                    <div id="btn-adm" class=" btn-adm-aling ">
                        ...
                        <div class="mdl-tooltip" data-mdl-for="btn-add-prova">
                            Adicionar uma questões à prova selecionada
                        </div>
                            ...
                            <tr>
                              ...
                              <i class="material-icons">more_vert</i>
                                        ...
                                        <ul class="mdl-menu mdl-js-menu mdl-js-ripple-effect" for="questao-1">
                                            <li><a  class="link-btn mdl-menu__item" href="tela-vizualiza-edita-questao.php">Ver/Editar</a></li>
                                            <li><a  class="link-btn mdl-menu__item" href="">Excluir</a></li>
                                        </ul>
                                    </p>
                                </td>
                            </tr>
